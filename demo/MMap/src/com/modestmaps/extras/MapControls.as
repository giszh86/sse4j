package com.modestmaps.extras {
	 ...
	 */    public class MapControls extends Sprite
    {
        ...
        public static const GROUPED:Object = {
            leftButton: { left: '15px', top: '40px' },
            rightButton: { left: '65px', top: '40px' },
            upButton: { left: '40px', top: '15px' },
            downButton: { left: '40px', top: '65px' },
            inButton: { left: '40px', top: '90px' },
            outButton: { left: '40px', top: '220px' },
            fullScreenButton: { left: '40px', top: '40px' }
        };
...
//        };
        ...
        private var positionFunctions:Object = {
        	left: function(map:Map, child:DisplayObject, s:String, a:String):void {
        		if (s.lastIndexOf("%") >= 0) {
        	...
        	right: function(map:Map, child:DisplayObject, s:String, a:String):void { 
        		if (s.lastIndexOf("%") >= 0) { 
        	...
        	top: function(map:Map, child:DisplayObject, s:String, a:String):void { 
        		if (s.lastIndexOf("%") >= 0) { 
        	...
        	bottom: function(map:Map, child:DisplayObject, s:String, a:String):void { 
        		if (s.lastIndexOf("%") >= 0) { 
        ...
        public function MapControls(map:Map, keyboard:Boolean=true, fullScreen:Boolean=false, buttonPositions:Object=null, buttonClass:Class=null)
        {
			...
			addChild(new ZoomSlider(this.map));
        ...
        private function onMapResize(event:Event):void
        {
            ...
            for (var child:String in positions) {
            	...
            	for (var reference:String in position) {
            		...
            		positionFunctions[reference](this.map, this[child], position[reference], position['align']);
            	}
            }
        }
